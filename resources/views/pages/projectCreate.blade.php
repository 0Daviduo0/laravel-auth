        ...
        <form method="POST" action="{{ route('project.store') }}" enctype="multipart/form-data">
            ...
            <div class="input_group">
                ...
                <div class=" input_field">
                    ...
                    <input class="name_field field" type="text" name="name">
                </div>
            ...
            <div class="descr_field">
                <label for="description"><i class="fa-solid fa-quote-left"></i> | Description</label><br>
                <textarea class="field" type="text" name="description" cols="120" rows="10"></textarea>
            </div>
            ...
            <div class="input_group">
                ...
                <div class=" input_field">
                    ...
                    <input class="date_field field" type="date" name="release_date">
                </div>
                
                <div class=" input_field">
                    <label for="repo_link"><i class="fa-solid fa-link"></i> | Github repo link</label><br>
                    <input class="link_field field" type="text" name="repo_link" value="http://github.com/">
                </div>
            ...
            <br>
            <input class="card_principal_button" type="submit" value="Crea nuovo progetto">
        </form>
